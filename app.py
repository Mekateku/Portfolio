...
def main():
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image(r"D:\BSIT4\CSIT342\Streamlit Portfolio\venv\Me.jpg", caption="Self Portrait", use_column_width=True)
    with col3:
        st.write(' ')
    ...
    with st.expander("Capstone Project: SocialSphere"):
        ...
        with col1:
            st.image(r"C:\Users\User\Pictures\Saved Pictures\login.png", caption="Login Page", use_column_width=True)
        with col2:
            st.image(r"C:\Users\User\Pictures\Saved Pictures\contentManager.png", caption="Content Manager Page", use_column_width=True)
        with col3:
            st.image(r"C:\Users\User\Pictures\Saved Pictures\analytics.png", caption="Analytics Page", use_column_width=True)
